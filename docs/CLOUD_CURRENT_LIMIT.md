...
Status: included in prerelease 3.0.3b3 with simulated tests.
...
Isolated 3.0.3b3 release tree (excluding unrelated native fault diagnostics):
1304 tests passed in 207.61 s; real-HA smoke and Ruff F passed. Pytest emitted
only a nonfunctional cache-write permission warning for the copied test tree.
